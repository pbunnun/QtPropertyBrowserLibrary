...
void QtSpinBoxFactory::connectPropertyManager(QtIntPropertyManager *manager)
{
    ...
    connect(manager, &QtIntPropertyManager::readOnlyChanged,
...
void QtSpinBoxFactory::disconnectPropertyManager(QtIntPropertyManager *manager)
{
    ...
    disconnect(manager, &QtIntPropertyManager::readOnlyChanged, this, nullptr);
}
...
void QtDoubleSpinBoxFactory::connectPropertyManager(QtDoublePropertyManager *manager)
{
    ...
    connect(manager, &QtDoublePropertyManager::readOnlyChanged,
            this, [this](QtProperty *property, bool readOnly)
            { d_ptr->slotReadOnlyChanged(property, readOnly); });
}
...
void QtDoubleSpinBoxFactory::disconnectPropertyManager(QtDoublePropertyManager *manager)
{
    ...
    disconnect(manager, &QtDoublePropertyManager::readOnlyChanged, this, nullptr);
}
...
void QtLineEditFactory::connectPropertyManager(QtStringPropertyManager *manager)
{
    ...
    connect(manager, &QtStringPropertyManager::readOnlyChanged,
            this, [this](QtProperty *property, bool readOnly)
            { d_ptr->slotReadOnlyChanged(property, readOnly); });
}
...
void QtLineEditFactory::disconnectPropertyManager(QtStringPropertyManager *manager)
{
    ...
    disconnect(manager, &QtStringPropertyManager::readOnlyChanged, this, nullptr);
}
...
class QtFilePathEditWidget : public QWidget
{
    Q_OBJECT
public:
    QtFilePathEditWidget(QWidget *parent = nullptr);
...
{
    QtFilePathEditorFactory *q_ptr = nullptr;
...
{
    connect(manager, &QtFilePathPropertyManager::valueChanged,
                this, [this](QtProperty *property, const QString & value)
                { d_ptr->slotPropertyChanged(property, value); });
    connect(manager, &QtFilePathPropertyManager::filterChanged,
                this, [this](QtProperty *property, const QString & value)
                { d_ptr->slotFilterChanged(property, value); });
    connect(manager, &QtFilePathPropertyManager::modeChanged,
                this, [this](QtProperty *property, const QString & value)
                { d_ptr->slotModeChanged(property, value); });
}
        ...
        QtProperty *property, QWidget *parent)
{
    ...
    connect(editor, &QtFilePathEditWidget::filePathChanged,
                this, [this](const QString & value){ d_ptr->slotSetValue(value); });
    connect(editor, &QObject::destroyed,
                this, [this](QObject * object){ d_ptr->slotEditorDestroyed(object); });
    return editor;
...
{
    disconnect(manager, &QtFilePathPropertyManager::valueChanged, this, nullptr);
    disconnect(manager, &QtFilePathPropertyManager::filterChanged, this, nullptr);
    disconnect(manager, &QtFilePathPropertyManager::modeChanged, this, nullptr);
}
...
class QtPathEditWidget : public QWidget
{
    Q_OBJECT
public:
    QtPathEditWidget(QWidget *parent = nullptr);
...
{
    connect(manager, &QtPathPropertyManager::valueChanged,
                this, [this](QtProperty *property, const QString & value)
                { d_ptr->slotPropertyChanged(property, value); });
}
        ...
        QtProperty *property, QWidget *parent)
{
    ...
    connect(editor, &QtPathEditWidget::pathChanged,
                this, [this](const QString & value){ d_ptr->slotSetValue(value); });
    connect(editor, &QObject::destroyed,
                this, [this](QObject * object){ d_ptr->slotEditorDestroyed(object); });
    return editor;
...
{
    disconnect(manager, &QtPathPropertyManager::valueChanged, this, nullptr);
}
