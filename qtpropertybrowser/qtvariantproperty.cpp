...
QtVariantPropertyManagerPrivate::QtVariantPropertyManagerPrivate() :
    ...
    m_echoModeAttribute("echoMode"_L1),
    m_readOnlyAttribute("readOnly"_L1),
    m_textVisibleAttribute("textVisible"_L1),
    m_filePathFilterAttribute("filter"_L1),
    m_filePathModeAttribute("mode"_L1)
{
}
    ...
    : QtAbstractPropertyManager(parent), d_ptr(new QtVariantPropertyManagerPrivate)
{
    ...
    d_ptr->m_typeToAttributeToAttributeType[QMetaType::Bool][d_ptr->m_textVisibleAttribute] =
            QMetaType::Bool;
    d_ptr->m_typeToValueType[QMetaType::Bool] = QMetaType::Bool;
    d_ptr->m_typeToAttributeToAttributeType[QMetaType::Bool][d_ptr->m_readOnlyAttribute] =
            QMetaType::Bool;
    connect(boolPropertyManager, &QtBoolPropertyManager::valueChanged,
            this, [this](QtProperty *property, bool value)
            { d_ptr->slotValueChanged(property, value); });
    connect(boolPropertyManager, &QtBoolPropertyManager::textVisibleChanged,
            this, [this](QtProperty *property, bool textVisible)
            { d_ptr->slotTextVisibleChanged(property, textVisible); });
    connect(boolPropertyManager, &QtBoolPropertyManager::readOnlyChanged,
            this, [this](QtProperty *property, bool readOnly)
            { d_ptr->slotReadOnlyChanged(property, readOnly); });
    ...
    connect(stringPropertyManager, &QtStringPropertyManager::echoModeChanged,
            this, [this](QtProperty *property, int value)
            { d_ptr->slotEchoModeChanged(property, value); });
    connect(stringPropertyManager, &QtStringPropertyManager::readOnlyChanged,
            this, [this](QtProperty *property, bool readOnly)
            { d_ptr->slotReadOnlyChanged(property, readOnly); });
    // DatePropertyManager
    ...
    d_ptr->m_typeToAttributeToAttributeType[QMetaType::QSize][d_ptr->m_maximumAttribute] =
            QMetaType::QSize;
    d_ptr->m_typeToAttributeToAttributeType[QMetaType::QSize][d_ptr->m_readOnlyAttribute] = 
            QMetaType::Bool;
    ...
    d_ptr->m_typeToAttributeToAttributeType[QMetaType::QSizeF][d_ptr->m_decimalsAttribute] =
            QMetaType::Int;
    d_ptr->m_typeToAttributeToAttributeType[QMetaType::QSizeF][d_ptr->m_readOnlyAttribute] = 
            QMetaType::Bool;
    ...
    connect(sizeFPropertyManager, &QtSizeFPropertyManager::rangeChanged,
            ...
            { d_ptr->slotRangeChanged(property, min, max); });
    connect(sizeFPropertyManager, &QtSizeFPropertyManager::decimalsChanged,
            this, [this](QtProperty *property, int value)
            { d_ptr->slotDecimalsChanged(property, value); });
    ...
    connect(rectFPropertyManager, &QtRectFPropertyManager::constraintChanged,
            this, [this](QtProperty *property, const QRectF &value)
            { d_ptr->slotConstraintChanged(property, value); });
    connect(rectFPropertyManager, &QtRectFPropertyManager::decimalsChanged,
            this, [this](QtProperty *property, int value)
            { d_ptr->slotDecimalsChanged(property, value); });
    ...
    auto *filePathPropertyManager = new QtFilePathPropertyManager(this);
    d_ptr->m_typeToPropertyManager[filePathId] = filePathPropertyManager;
    d_ptr->m_typeToValueType[filePathId] = QMetaType::QString;
    d_ptr->m_typeToAttributeToAttributeType[filePathId][d_ptr->m_filePathFilterAttribute] = QMetaType::QString;
    d_ptr->m_typeToAttributeToAttributeType[filePathId][d_ptr->m_filePathModeAttribute] = QMetaType::QString;
    connect(filePathPropertyManager, &QtFilePathPropertyManager::valueChanged,
            this, [this](QtProperty *property, const QString &value)
            { d_ptr->slotValueChanged(property, value); });
    connect(filePathPropertyManager, &QtFilePathPropertyManager::filterChanged,
            this, [this](QtProperty *property, const QString &value)
            { d_ptr->slotFilePathFilterChanged(property, value); });
    connect(filePathPropertyManager, &QtFilePathPropertyManager::modeChanged,
            this, [this](QtProperty *property, const QString &value)
            { d_ptr->slotFilePathModeChanged(property, value); });
    // PathPropertyManager
...
QVariant QtVariantPropertyManager::value(const QtProperty *property) const
{
    ...
    } else if (auto *filePathManager = qobject_cast<QtFilePathPropertyManager *>(manager)) {
        return filePathManager->value(internProp);
    } else if (auto *pathManager = qobject_cast<QtPathPropertyManager *>(manager)) {
